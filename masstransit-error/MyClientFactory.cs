    ...
    IAsyncDisposable
{
    ...
    public MyClientFactory(ClientFactoryContext context)
    {
        _context = context;
    }
        ...
        where T : class
    {
        ...
        return new MyRequestClient<T>(_context, _context.GetRequestEndpoint<T>(), timeout.Or(_context.DefaultTimeout));
    }
        ...
        where T : class
    {
        ...
        return new MyRequestClient<T>(_context, _context.GetRequestEndpoint<T>(consumeContext), timeout.Or(_context.DefaultTimeout));
    }
